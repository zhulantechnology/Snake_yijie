...
public interface IOpWorkingMessageExt {
    /**
     * Attachment enhance
     * @param type
     * @param opSlideshowEditorCallback
     * @return
     * @internal
     */
    boolean setAttachment(int type, int attachType,
            ISlideshowEditorCallback opSlideshowEditorCallback);

    /**
     * change media
     * @param increaseSize
     * @param attachFilesSize
     * @return
     * @internal
     */
    int changeMedia(int increaseSize, int attachFilesSize);

    /**
     * @internal
     */
    boolean removeAllAttachFiles();
