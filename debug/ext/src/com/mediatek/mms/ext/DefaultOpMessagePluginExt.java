...
public class DefaultOpMessagePluginExt implements IOpMessagePluginExt {
    ...
    @Override
    public IOpSendTransactionExt getOpSendTransactionExt() {
        return new DefaultOpSendTransactionExt(mContext);
    }
    @Override
    ...
    @Override
    public IOpNotificationPreferenceActivityExt getOpNotificationPreferenceActivityExt() {
        return new  DefaultOpNotificationPreferenceActivityExt();
    }

    @Override
    public IOpCBMessagingNotificationExt getOpCBMessagingNotificationExt() {
        return new DefaultOpCBMessagingNotificationExt(mContext);
    }
