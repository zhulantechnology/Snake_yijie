...
public interface IOpMessagePluginExt {
     ...
     * @internal
     */
    IOpSmilHelperExt getOpSmilHelperExt();

    /**
     * @internal
     */
    IOpSendTransactionExt getOpSendTransactionExt();

    /**
     * @internal
     */
    IOpMmsMessageSenderExt getOpMmsMessageSenderExt();

    /**
     * @internal
     */
    IOpNotificationPreferenceActivityExt getOpNotificationPreferenceActivityExt();

    /**
     * @internal
     */
    IOpCBMessagingNotificationExt getOpCBMessagingNotificationExt();

    /**
     * @internal
     */
    IOpSettingListActivityExt getOpSettingListActivityExt();
}
