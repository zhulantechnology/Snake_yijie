...
public class MmsWidgetProxyActivity extends Activity implements IMmsWidgetProxyActivityCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MmsLog.d(TAG, "onCreate Action is " + intent.getAction());
	...
	protected void onResume() {
		...
		super.onResume();
		threadListQueryHandler.startDelete(MmsWidgetProvider.DELETE_OBSOLETE_THREADS_TOKEN, null, Threads.OBSOLETE_THREADS_URI, null, null);
	}
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		super.onDestroy();
		if (threadListQueryHandler != null) {
            threadListQueryHandler.removeCallbacksAndMessages(null);
            threadListQueryHandler.cancelOperation(MmsWidgetProvider.DELETE_OBSOLETE_THREADS_TOKEN);
        }
    ...
    private void getUnreadInfo(final Uri uri, final Context context) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Cursor cursor =
                    context.getContentResolver().query(uri, null, " read=0 ", null, null);
