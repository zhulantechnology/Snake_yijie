...
public class MessagingNotificationProxyReceiver extends BroadcastReceiver {
    ...
    private boolean handleTopActivity(final Context context,
            ComposeMessageActivity composer, final Intent intent) {
            ...
            if (composerTaskInfor != null) {
                ...
                if (topActivityClassName.contains("com.android.mms.ui.ComposeMessageActivity") ||
                        topActivityClassName.
                            contains("com.android.mms.ui.ForwardMessageActivity")) {
                    am.moveTaskToFront(composer_task_id, 0);
                    MessageUtils.showDiscardDraftConfirmDialog(composer,
