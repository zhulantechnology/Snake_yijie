...
public class MmsSystemEventReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        /// @}
            ...
            /// M:Code analyze 004, modify the logic,if
            /// data connection change,unRegister the listener of
            ...
            if (PhoneConstants.APN_TYPE_MMS.equals(apnType)) {
                MmsLog.d(MmsApp.TXN_TAG,
                        "ACTION_ANY_DATA_CONNECTION_STATE_CHANGED, type is mms.");
    ...
    /// M:Code analyze 001,add new variable for save draft mms when received event of shutdown @{
