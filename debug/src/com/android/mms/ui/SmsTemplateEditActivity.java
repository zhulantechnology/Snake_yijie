...
public class SmsTemplateEditActivity extends Activity {
    ...
    //Add, DWYBL-208, DaiHongyi, 20150403, start
    private  final TextWatcher mTextWatcher = new TextWatcher() {
		...
		public void afterTextChanged(Editable s) {
			// TODO Auto-generated method stub
			Log.e("chenshu","s.length"+s.length());
			if (s.length()==MAX_EDITABLE_LENGTH){
				Toast.makeText(SmsTemplateEditActivity.this, getResources().getString(R.string.exceed_subject_length_limitation), Toast.LENGTH_LONG).show();
			}
		}
	    };
    //Add, DWYBL-208, DaiHongyi, 20150403, End
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (getWindow() != null && getWindow().getCurrentFocus() != null) {
                    inputM.hideSoftInputFromWindow(getWindow().getCurrentFocus().getWindowToken(),
                            0);
                }
	 ...
	 //Add, DWYBL-208, DaiHongyi, 20150403, start
	 mNewQuickText.removeTextChangedListener(mTextWatcher);
        mNewQuickText.addTextChangedListener(mTextWatcher);
	 //Add, DWYBL-208, DaiHongyi, 20150403, End
        ...
        MmsLog.d(TAG, "onCreate updateAllQuicktexts mMaxQuickTextId: " + mMaxQuickTextId
                + " allQuickTexts : " + MmsConfig.getQuicktexts());
        //modify DWYQFSQ-476 chengguangshuai 20160803 start	
		//adapter = new ArrayAdapter<String>(this, R.layout.quick_text_edit_item,
		//   MmsConfig.getQuicktexts());  
		if(MmsApp.getApplication().getResources().getBoolean(R.bool.enable_message_templates)){
			adapter = new ArrayAdapter<String>(this, R.layout.quick_text_edit_item,
                MmsConfig.getTemplatesQuicktexts());
		}else{
		adapter = new ArrayAdapter<String>(this, R.layout.quick_text_edit_item,
				MmsConfig.getQuicktexts()); 
		}
		//modify DWYQFSQ-476 chengguangshuai 20160803 end	
    ...
    private boolean addST(String str) {
        ...
        //A: DWYBL-724  guochenlong  20150420  (Start) @{
        /**
         * get mMaxQuickTextId before insert to DB
         */
        if(!MmsConfig.getInitQuickText()) {
            mMaxQuickTextId = MmsConfig.updateAllQuicktexts();
        }
    ...
    private int delST(Integer id) {
        return getContentResolver().delete(Telephony.MmsSms.CONTENT_URI_QUICKTEXT,
                _ID + "=" + id, null);
    }
    ...
    private int updateST(Integer id, String text) {
        ...
        return getContentResolver().update(Telephony.MmsSms.CONTENT_URI_QUICKTEXT,
                values, _ID + "=" + id, null);
    }
    ...
    private void showEditDialog(String quickText) {
        ...
        //Add DSYYLM-189 chenshu 20140111 start
        mOldQuickText.setSelection(quickText.length());
        //Add DSYYLM-189 chenshu 20140111 end
        ...
        //Add, DWLLL-236, DaiHongyi, 20150403, Start
        mOldQuickText.removeTextChangedListener(mTextWatcher);
        mOldQuickText.addTextChangedListener(mTextWatcher);
        //Add, DWLLL-236, DaiHongyi, 20150403, End
