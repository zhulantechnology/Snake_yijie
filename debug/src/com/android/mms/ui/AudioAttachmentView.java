...
public class AudioAttachmentView extends LinearLayout implements
    ...
    public void setAudio(Uri audio, String name, Map<String, ?> extras) {
        ...
        if (audio != null && DrmUtilsEx.checkHasDrmContent(mContext, name, audio)) {
            drmBitmap = DrmUtilsEx.getDrmBitmapWithLockIcon(mContext,
                R.drawable.ic_launcher_record_audio, audio);
        }
        if (drmBitmap != null) {
            mAudioImageView.setImageBitmap(drmBitmap);
        } else {
            mAudioImageView.setImageResource(R.drawable.ic_launcher_record_audio);
        }
    }
