...
public class SearchActivity extends ListActivity {
    ...
    public static class TextViewSnippet extends TextView {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            MmsLog.d(TAG, "onLayout startPos = " + startPos
            ...
            if (searchStringWidth >= textFieldWidth) {
                ...
                try {
                     ...
                     MmsLog.e(TAG, " StringIndexOutOfBoundsException ");
                     e.printStackTrace();
                     /// M: for search je.
    ...
    Contact.UpdateListener mContactListener = new Contact.UpdateListener() {
        public void onUpdate(final Contact updated) {
            Log.d(TAG, "SearchActivity#onUpdate, contact updated: " + updated);
                ...
                if (cursorCount > 0) {
                    ...
                    if (recent != null) {
                        recent.saveRecentQuery(searchString,
                                getString(R.string.search_history, cursorCount, searchString));
                    }
                }
            }
        };
    ...
    private String getSearchString() {
        ...
        return searchStringParameter !=
            null ? searchStringParameter.trim() : searchStringParameter;
    }
    /// @}
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            if (cursor.getInt(6) == 0) {
                EncodedStringValue v =
                    new EncodedStringValue(addrCharset, PduPersister.getBytes(address));
                address = v.getString();
            }
            ...
            String body = IpMessageUtils.formatIpMessage(
                cursor.getString(bodyPos), false, null).toString();
            if (cursor.getInt(6) == 0) {
            ...
            // modify  BUG_ID: JSLEL-765   zhangyuwen  20140925(start)
            //snippet.setText(body, searchString);
            final long threadId1 = cursor.getLong(threadIdPos);
            Conversation conv1 = Conversation.get(SearchActivity.this, threadId1, false);
            if(EncryptionActivity.supportEncryptedMessage()) {
                if (conv1 != null && conv1.mEncrypted == 1) {
                    snippet.setText("******", "");
                } else {
                    snippet.setText(body, searchString);
                }
            ...
            // modify  BUG_ID: JSLEL-765   zhangyuwen  20140925(end)
            ...
            view.setOnClickListener(new View.OnClickListener() {
                private void initializeClickIntent(Intent onClickIntent,
                        int msgType, int msgBox, long rowid) {
                    if (msgType == 1) {
                        if (msgBox == 3) { //draft
                            onClickIntent.setClass(SearchActivity.this,
                                    ComposeMessageActivity.class);
                        } else {
                        ...
                        if (msgBox == 3) { //draft
                              ...
                              if (msgBox == 1 && m_type == 130) {
                                  Toast.makeText(SearchActivity.this,
                                          R.string.view_mms_notification,
                                          Toast.LENGTH_SHORT).show();
                                  return;
                              } else {
                                  final Uri MMS_URI = Uri.parse("content://mms/");
                                  onClickIntent.setClass(SearchActivity.this,
                                          MmsPlayerActivity.class);
                                  onClickIntent.setData(
                                          ContentUris.withAppendedId(MMS_URI, rowid));
                    ...
                    if (FeatureOption.MTK_WAPPUSH_SUPPORT == true) {
                        ...
                        if (!dirMode) {
                            if (threadType == 1) {
								...
								//Add Bug Id:JSLEL-1774 chenshu 20141027 (start)
								if(EncryptionActivity.encryptionEnabled() && nmsgConv != null && nmsgConv.getEncryption() == 1) {
									final Uri threadUri = nmsgConv.getUri().buildUpon().appendQueryParameter("isRcse", "true").build();
									if(threadUri != null) {
										Intent checkEncryptionIntent = new Intent(SearchActivity.this, EncryptionActivity.class);
										...
										startActivity(checkEncryptionIntent);
										return;
									} 
								}
								//Add Bug Id:JSLEL-1774 chenshu 20141027 (end)
