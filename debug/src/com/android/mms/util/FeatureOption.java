...
public final class FeatureOption {
    ...
    public static final boolean MTK_BRAZIL_CUSTOMIZATION_CLARO =
        SystemProperties.get("ro.brazil_cust_claro").equals("1");

    public static final boolean MTK_SEND_RR_SUPPORT =
        SystemProperties.get("ro.mtk_send_rr_support").equals("1");
    ...
    public static final boolean MTK_IMS_SUPPORT = SystemProperties.
            get("persist.mtk_ims_support").equals("1");
     ...
     */
    public static final boolean MTK_PERF_RESPONSE_TIME =
        SystemProperties.get("ro.mtk_perf_response_time").equals("1");
}
