...
public class SmsPreferenceActivity extends PreferenceActivity implements
    ...
    public static final String SMS_ENCODING_MODE = "pre_sms_encoding_mode";

    public static final String SETTING_ENCONDING_MODE_AUTO = "Automatic";

    public static final String SETTING_ENCONDING_MODE_7BIT = "7bit";
    ...
    //Add,  Mms-SmsEncoding7Bit Start
    private ListPreference mSmsEnconding;
    //Add,  Mms-SmsEncoding7Bit End
    ...
    private void setMessagePreferences() {
        ...
        //Add,  Mms-SmsEncoding7Bit Start
        mSmsEnconding = (ListPreference)findPreference(SMS_ENCODING_MODE);

        if(!MmsConfig.isEnable7BitSmsEncoding() || getResources().getBoolean(R.bool.disable_pref_show)){
            smsCategory.removePreference(mSmsEnconding);
        }
        /*
        disable_pref_show means whether show the preference. in project BLU never show .please check
        the resources overlay about 805_blu_82(kk platform).*/
        if(getResources().getBoolean(R.bool.disable_pref_show)){
            smsCategory.removePreference(mSmsEnconding);
        }
        //Add,  Mms-SmsEncoding7Bit End
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        if (preference == mManageSimPref) {
            ...
            if (result != null
                ...
                MmsLog.d(TAG, "getScAddress not support error: " + result);
            } else {
    ...
    private void restoreDefaultPreferences() {
        ...
        if (MmsConfig.isEnable7BitSmsEncoding()) {
            editor.putString(SMS_ENCODING_MODE, SETTING_ENCONDING_MODE_7BIT);
        }
        //Add,  Mms-SmsEncoding7Bit Ends
