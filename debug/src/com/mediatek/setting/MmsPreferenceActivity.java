...
public class MmsPreferenceActivity extends PreferenceActivity
	...
	//add by chenshu JWYYL-1510 20150121
	private static final String SIZE_LIMIT_CUSTOM = String.valueOf(MmsApp.getApplication().getResources().getInteger			(R.integer.mms_custom_size));
    ...
    private void setListPrefSummary() {
		...
		if(getResources().getBoolean(R.bool.support_MMS_max_size_limit)){
			stored = sp.getString(MMS_SIZE_LIMIT, SIZE_LIMIT_CUSTOM);
        mMmsSizeLimit.setSummary(MessageUtils.getVisualTextName(this, stored, R.array.pref_mms_size_limit_choices_custom,
            R.array.pref_mms_size_limit_values_custom));
		}else{
			stored = sp.getString(MMS_SIZE_LIMIT, SIZE_LIMIT_300);
        mMmsSizeLimit.setSummary(MessageUtils.getVisualTextName(this, stored, R.array.pref_mms_size_limit_choices,
            R.array.pref_mms_size_limit_values));
    ...
    private void restoreDefaultPreferences() {
		...
		//Modify JWYYL-1510 chenshu 20150121 start
		if(getResources().getBoolean(R.bool.support_MMS_max_size_limit)){
			editor.putString(MMS_SIZE_LIMIT, SIZE_LIMIT_CUSTOM);
		}else{
		...
		editor.putBoolean(GROUP_MMS_MODE, getResources().getBoolean(R.bool.default_group_on));
		//Modify JWYYL-1510 chenshu 20150121 end
...
//        new EncapsulatedListView(this.getListView()).clearScrapViewsIfNeeded();//csw
    ...
    public static boolean getIsGroupMmsEnabled(Context context) {
		...
		boolean groupMmsPrefOn = prefs.getBoolean(MmsPreferenceActivity.GROUP_MMS_MODE, context.getResources().getBoolean(R.bool.default_group_on));
		//Modify JWYYL-1510 chenshu 20150121 end
