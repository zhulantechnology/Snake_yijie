...
public class MessageTabSettingActivity extends Activity implements TabListener {
    ...
    private boolean mIsActivityPause = true;
    ...
    public void addFragment() {
        ...
        Log.d(TAG, "addFragment simCount = " + simCount);
        switch (simCount) {
        case 0:
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem restoreMenu = menu.findItem(MENU_RESTORE_DEFAULT);
        if (restoreMenu != null) {
            restoreMenu.setEnabled(isSmsEnabled);
        }
        return true;
    }
    ...
    private BroadcastReceiver mSimReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(TelephonyIntents.ACTION_SUBINFO_RECORD_UPDATED)) {
                ...
                if (!mIsActivityPause && MessageTabSettingActivity.this.hasWindowFocus()) {
                    addFragment();
                } else {
                    isSimChanged = true;
                }
