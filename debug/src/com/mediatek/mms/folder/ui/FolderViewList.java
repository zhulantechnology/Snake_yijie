...
//            invalidateOptionsMenu();
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (TelephonyManager.getDefault().getPhoneCount() > 1 && listSimInfo != null &&
                        ...
                        while (iter.hasNext()) {
                            ...
                            if (entry.getValue()) {
                                ...
                                if (entry.getKey() > 100000) {
                                    ...
                                    Log.d(TAG, "CB :-entry.getKey() +100000= "
                                            + (-(entry.getKey() + 100000)));
                                    Log.d(TAG, "argsSms[i]" + argsCb[k]);
                                    deleteCbUri = CB_URI;
                                    k++;
                                } else if (entry.getKey() < 0) {
                                    argsMms[j] = Long.toString(-entry.getKey());
                                    Log.d(TAG, "mms :-entry.getKey() = " + (-entry.getKey()));
                                    Log.d(TAG, "argsMms[j]" + argsMms[j]);
