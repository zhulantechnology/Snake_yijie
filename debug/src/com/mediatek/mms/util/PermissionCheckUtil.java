    ...
    public static boolean requestAllPermissions(Activity activity) {
        if (CtaUtils.isCtaSupported()) {
            if (CtaUtils.isEmailMmsSupported()) {
                ...
                return requestPermissions(activity, ALL_CTA_PERMISSIONS_NO_SEND_MMS);
            }
        } else {
    ...
    public static boolean requestRequiredPermissions(Activity activity) {
        if (CtaUtils.isCtaSupported()) {
            if (CtaUtils.isEmailMmsSupported()) {
                ...
                return requestPermissions(activity, REQUIRED_CTA_PERMISSIONS_NO_SEND_MMS);
            }
        } else {
    ...
    public static boolean checkAllPermissions(Context context) {
        if (CtaUtils.isCtaSupported()) {
            if (CtaUtils.isEmailMmsSupported()) {
                ...
                return checkPermissions(context, ALL_CTA_PERMISSIONS_NO_SEND_MMS);
            }
        } else {
    ...
    public static boolean checkRequiredPermissions(Context context) {
        if (CtaUtils.isCtaSupported()) {
            if (CtaUtils.isEmailMmsSupported()) {
                ...
                return checkPermissions(context, REQUIRED_CTA_PERMISSIONS_NO_SEND_MMS);
            }
        } else {
    ...
    public static boolean onRequestPermissionsResult(
        ...
        if (CtaUtils.isCtaSupported()) {
            if (CtaUtils.isEmailMmsSupported()) {
                ...
                requiredPermissions = REQUIRED_CTA_PERMISSIONS_NO_SEND_MMS;
            }
        } else {
