...
class RecoverChannelSettings {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (channelState) {
                if (infoList == null) {
                    ...
                    info[0] = infoList;
                    boolean isSetSuccess = setCellBroadcastConfig(info,
    ...
    private boolean setCellBroadcastConfig(SmsBroadcastConfigInfo[] objectList,
        ...
        MmsLog.d(LOG_TAG, "setCellBroadcastConfig and isSetConfigSuccess =" + isSetConfigSuccess
                + " ChannelId from " + fromId + " to " + toId);
